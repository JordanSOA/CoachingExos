...
public class MeetupTest {
    ...
    public void testMonteenthOfMay2013() {
        ...
        assertEquals(expected, meetup.day(DayOfWeek.MONDAY, Meetup.MeetupSchedule.TEENTH));
    }
    ...
    public void testTuesteenthOfMarch2013() {
        ...
        assertEquals(expected, meetup.day(DayOfWeek.TUESDAY, Meetup.MeetupSchedule.TEENTH));
    }
    ...
    public void testWednesteenthOfJanuary2013() {
        ...
        assertEquals(expected, meetup.day(DayOfWeek.WEDNESDAY, Meetup.MeetupSchedule.TEENTH));
    }
    ...
    public void testThursteenthOfMay2013() {
        ...
        Meetup meetup = new Meetup(5, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.THURSDAY, Meetup.MeetupSchedule.TEENTH));
    }
    ...
    public void testFriteenthOfApril2013() {
        ...
        Meetup meetup = new Meetup(4, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.FRIDAY, Meetup.MeetupSchedule.TEENTH));
    }
    ...
    public void testSaturteenthOfFebruary2013() {
        ...
        Meetup meetup = new Meetup(2, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SATURDAY, Meetup.MeetupSchedule.TEENTH));
    }
    ...
    public void testSunteenthOfMay2013() {
        ...
        Meetup meetup = new Meetup(5, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SUNDAY, Meetup.MeetupSchedule.TEENTH));
    }
    ...
    public void testFirstMondayOfMarch2013() {
        ...
        Meetup meetup = new Meetup(3, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.MONDAY,Meetup.MeetupSchedule.FIRST));
    }
    ...
    public void testFirstTuesdayOfMay2013() {
        ...
        Meetup meetup = new Meetup(5, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.TUESDAY,Meetup.MeetupSchedule.FIRST));
    }
    ...
    public void testFirstWednesdayOfJuly2013() {
        ...
        assertEquals(expected, meetup.day(DayOfWeek.WEDNESDAY,Meetup.MeetupSchedule.FIRST));
    }
    ...
    public void testFirstThursdayOfSeptember2013() {
        ...
        Meetup meetup = new Meetup(9, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.THURSDAY,Meetup.MeetupSchedule.FIRST));
    }
    ...
    public void testFirstFridayOfNovember2013() {
        ...
        assertEquals(expected, meetup.day(DayOfWeek.FRIDAY,Meetup.MeetupSchedule.FIRST));
    }
    ...
    public void testFirstSaturdayOfJanuary2013() {
        ...
        Meetup meetup = new Meetup(1, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SATURDAY,Meetup.MeetupSchedule.FIRST));
    }
    ...
    public void testFirstSundayOfMarch2013() {
        ...
        Meetup meetup = new Meetup(3, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SUNDAY,Meetup.MeetupSchedule.FIRST));
    }
    ...
    public void testSecondMondayOfMarch2013() {
        ...
        Meetup meetup = new Meetup(3, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.MONDAY,Meetup.MeetupSchedule.SECOND));
    }
    ...
    public void testSecondTuesdayOfMay2013() {
        ...
        Meetup meetup = new Meetup(5, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.TUESDAY,Meetup.MeetupSchedule.SECOND));
    }
    ...
    public void testSecondWednesdayOfJuly2013() {
        ...
        Meetup meetup = new Meetup(7, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.WEDNESDAY,Meetup.MeetupSchedule.SECOND));
    }
    ...
    public void testSecondThursdayOfSeptember2013() {
        ...
        Meetup meetup = new Meetup(9, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.THURSDAY,Meetup.MeetupSchedule.SECOND));
    }
    ...
    public void testSecondFridayOfNovember2013() {
        ...
        Meetup meetup = new Meetup(11, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.FRIDAY,Meetup.MeetupSchedule.SECOND));
    }
    ...
    public void testSecondSaturdayOfJanuary2013() {
        ...
        Meetup meetup = new Meetup(1, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SATURDAY,Meetup.MeetupSchedule.SECOND));
    }
    ...
    public void testSecondSundayOfMarch2013() {
        ...
        Meetup meetup = new Meetup(3, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SUNDAY,Meetup.MeetupSchedule.SECOND));
    }
    ...
    public void testThirdMondayOfMarch2013() {
        ...
        Meetup meetup = new Meetup(3, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.MONDAY,Meetup.MeetupSchedule.THIRD));
    }
    ...
    public void testThirdTuesdayOfMay2013() {
        ...
        Meetup meetup = new Meetup(5, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.TUESDAY,Meetup.MeetupSchedule.THIRD));
    }
    ...
    public void testThirdWednesdayOfJuly2013() {
        ...
        Meetup meetup = new Meetup(7, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.WEDNESDAY,Meetup.MeetupSchedule.THIRD));
    }
    ...
    public void testThirdThursdayOfSeptember2013() {
        LocalDate expected = LocalDate.of(2013, 9, 19);
        Meetup meetup = new Meetup(9, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.THURSDAY,Meetup.MeetupSchedule.THIRD));
    }
    ...
    public void testThirdFridayOfNovember2013() {
        ...
        Meetup meetup = new Meetup(11, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.FRIDAY,Meetup.MeetupSchedule.THIRD));
    }
    ...
    public void testThirdSaturdayOfJanuary2013() {
        ...
        Meetup meetup = new Meetup(1, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SATURDAY,Meetup.MeetupSchedule.THIRD));
    }
    ...
    public void testThirdSundayOfMarch2013() {
        ...
        Meetup meetup = new Meetup(3, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SUNDAY, Meetup.MeetupSchedule.THIRD));
    }
    ...
    public void testFourthMondayOfMarch2013() {
        ...
        Meetup meetup = new Meetup(3, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.MONDAY, Meetup.MeetupSchedule.FOURTH));
    }
    ...
    public void testFourthTuesdayOfMay2013() {
        ...
        Meetup meetup = new Meetup(5, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.TUESDAY, Meetup.MeetupSchedule.FOURTH));
    }
    ...
    public void testFourthWednesdayOfJuly2013() {
        ...
        Meetup meetup = new Meetup(7, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.WEDNESDAY, Meetup.MeetupSchedule.FOURTH));
    }
    ...
    public void testFourthThursdayOfSeptember2013() {
        ...
        Meetup meetup = new Meetup(9, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.THURSDAY, Meetup.MeetupSchedule.FOURTH));
    }
    ...
    public void testFourthFridayOfNovember2013() {
        ...
        Meetup meetup = new Meetup(11, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.FRIDAY, Meetup.MeetupSchedule.FOURTH));
    }
    ...
    public void testFourthSaturdayOfJanuary2013() {
        ...
        Meetup meetup = new Meetup(1, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SATURDAY, Meetup.MeetupSchedule.FOURTH));
    }
    ...
    public void testFourthSundayOfMarch2013() {
        ...
        Meetup meetup = new Meetup(3, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SUNDAY, Meetup.MeetupSchedule.FOURTH));
    }
    ...
    public void testLastMondayOfMarch2013() {
        LocalDate expected = LocalDate.of(2013, 3, 25);
        Meetup meetup = new Meetup(3, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.MONDAY, Meetup.MeetupSchedule.LAST));
    }
    ...
    public void testLastTuesdayOfMay2013() {
        LocalDate expected = LocalDate.of(2013, 5, 28);
        Meetup meetup = new Meetup(5, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.TUESDAY, Meetup.MeetupSchedule.LAST));
    }
    ...
    public void testLastWednesdayOfJuly2013() {
        ...
        Meetup meetup = new Meetup(7, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.WEDNESDAY, Meetup.MeetupSchedule.LAST));
    }
    ...
    public void testLastThursdayOfSeptember2013() {
        LocalDate expected = LocalDate.of(2013, 9, 26);
        Meetup meetup = new Meetup(9, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.THURSDAY, Meetup.MeetupSchedule.LAST));
    }
    ...
    public void testLastFridayOfNovember2013() {
        ...
        Meetup meetup = new Meetup(11, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.FRIDAY, Meetup.MeetupSchedule.LAST));
    }
    ...
    public void testLastSaturdayOfJanuary2013() {
        LocalDate expected = LocalDate.of(2013, 1, 26);
        Meetup meetup = new Meetup(1, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SATURDAY, Meetup.MeetupSchedule.LAST));
    }
    ...
    public void testLastSundayOfMarch2013() {
        ...
        Meetup meetup = new Meetup(3, 2013);
        assertEquals(expected, meetup.day(DayOfWeek.SUNDAY, Meetup.MeetupSchedule.LAST));
    }
